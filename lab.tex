...
% Metadata
% ------------------------------------------
\renewcommand{\labtitle}{Praktikum V: Drehpendel}
\renewcommand{\labsubtitle}{Reglerentwurf inverses Drehpendel mit Hilfe der Wurzelortskurve}
...
Weitere Infos unter
\href{https://www.maxongroup.com/}{\color{blueColor}Maxon Motor AG}.
Beachten Sie die Farbdefinition \texttt{blueColor} aus \texttt{labstyle.sty}.
