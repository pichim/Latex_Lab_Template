...
\begin{gentable}{ll}{Parameter des Drehpendels}
    ...
    Trägheitsmoment des Pendels $J_p$ & $\qty{6.063e-5}{\kilogram\metre\squared}$ \\
...
\begin{aufgaben}
    ...
    \item Welche Grösse bestimmt den Systemeingang und welche den Systemausgang?
\end{aufgaben}
