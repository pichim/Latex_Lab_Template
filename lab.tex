...
% Metadata
% ------------------------------------------
\renewcommand{\labtitle}{Praktikum I — Cuboid: Regelung eines EC-Motors}
\renewcommand{\labsubtitle}{Laborbeschreibung}
\renewcommand{\labauthor}{Ihr Name / Institut}
...
Weitere Infos unter
\href{https://www.maxongroup.com/}{\color{labBlue}Maxon Motor AG}.
Beachten Sie die Farbdefinition \texttt{labBlue} aus \texttt{labstyle.sty}.
