...
\areaset{175mm}{290mm}
% Shift the whole layout block (header + text + footer) down on the paper.
% Positive value moves everything down; reduce if bottom margin gets too small.
...
\renewcommand{\labsubtitle}{Drehpendel: Reglerentwurf inverses Drehpendel mit Hilfe der Wurzelortskurve}
